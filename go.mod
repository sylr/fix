...
require (
	...
	sylr.dev/yaml/age/v3 v3.0.0-20221119155624-67ccfe668261
...
replace (
	...
	github.com/quickfixgo/quickfix => github.com/sylr/quickfix-go v0.6.1-0.20221129212007-d4de11e859fe
