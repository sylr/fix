...
func (f FIX50) Version() string {
	return "FIX.5.0"
}

func (f FIX50) TagName(tag int) (string, bool) {
	switch tag {
	case 1:
		return "Account", true
	case 2:
...
func (f FIX50) ValueName(tag int, value string) (string, bool) {
	switch tag {
	case 4:
		switch value {
		case "B":
	...
	case 18:
		...
		case "H":
			return `Reinstate on system failue (mutually exclusive with Q)`, true
		case "I":
			return `Institutions only`, true
		case "J":
			return `Reinstate on Trading Halt (mutually exclusive with K)`, true
		case "K":
			return `Cancel on Trading Halt (mutually exclusive with J)`, true
		case "L":
	...
	case 35:
		...
		case "C":
			return `Email`, true
		case "D":
			return `New Order - Single`, true
		case "E":
			return `New Order - List`, true
		case "F":
			return `Order Cancel Request`, true
		case "G":
			return `Order Cancel/Replace Request (a.k.a. Order Modification Request)`, true
		case "H":
		...
		case "n":
			return `XML message (e.g. non FIX Msg Type)`, true
		case "o":
		...
		case "AS":
			return `Allocation Report (a.k.a. Allocation Claim)`, true
		case "AT":
			return `Allocation Report Ack (a.k.a. Allocation Claim Ack)`, true
		case "AU":
			return `Confirmation Ack (a.k.a. Affirmation)`, true
		case "AV":
		...
		case "BI":
			return `Trading Session List Request`, true
		case "BJ":
			return `Trading Session List`, true
		case "BK":
			return `Security List Update Report`, true
		case "BL":
			return `Adjusted Position Report`, true
		case "BM":
			return `Allocation Instruction Alert`, true
		case "BN":
			return `Execution Acknowledgement`, true
		case "BO":
			return `Contrary Intention Report`, true
		case "BP":
			return `Security Definition Update Report`, true
		}
	...
	case 167:
		...
		case "OOP":
			return `Options on Physical`, true
		case "WLD":
			return `Wildcard Entry (was "?" in 4.4, used on Security Definition Request message)`, true
		case "CASH":
			return `Cash`, true
		}
	...
	case 277:
		...
		case "AN":
			return `Offical Closing Price`, true
		case "AO":
	...
	case 574:
		switch value {
		case "60":
			return `One-Party Privately Negotiated Trade Report`, true
		case "61":
			return `Two-Party Privately Negotiated Trade Report`, true
		case "62":
			return `Continuous Auto-match`, true
		case "63":
	...
	case 749:
		...
		case "9":
			return `Unauthorized ror Trade Capture Report Request`, true
		case "99":
			return `Other`, true
		}
...
(iii) market maker is reporting the onward leg of a riskless principal transaction where the legs are executed at different prices, and another market maker has submitted a trade report using trade type indicator M for the first leg (this requires a single trade report with trade type indicator R).)`, true
	...
	case 840:
		...
		case "3":
			return `Global`, true
		case "4":
			return `National xxcluding local`, true
		}
	...
	case 1081:
		switch value {
		case "0":
			return `SecondaryOrdeID (198)`, true
		case "1":
			return `OrdeID (37)`, true
		case "2":
			return `MEntryID (278)`, true
		case "3":
			return `QuotEntryID (299)`, true
		}
