...
type FIX50SP2 struct {
}

func (f FIX50SP2) Version() string {
	return "FIX.5.0SP2"
}

func (f FIX50SP2) TagName(tag int) (string, bool) {
	switch tag {
	case 1:
		return "Account", true
	case 2:
...
func (f FIX50SP2) ValueName(tag int, value string) (string, bool) {
	switch tag {
	case 4:
		switch value {
		case "B":
