...
type FIX50SP2CME struct {
}

func (f FIX50SP2CME) Version() string {
	return "FIX.5.0SP2+CME"
}

func (f FIX50SP2CME) TagName(tag int) (string, bool) {
	switch tag {
	case 1:
		return "Account", true
	case 2:
	...
	case 1716:
		return "UnitOfMeasureCurrency", true
	case 1717:
		return "PriceUnitOfMeasureCurrency", true
	case 1718:
		return "UnderlyingUnitOfMeasureCurrency", true
	case 1719:
		return "UnderlyingPriceUnitOfMeasureCurrency", true
	case 1720:
		return "LegUnitOfMeasureCurrency", true
	case 1721:
		return "LegPriceUnitOfMeasureCurrency", true
	case 1722:
		return "DerivativeUnitOfMeasureCurrency", true
	case 1723:
		return "DerivativePriceUnitOfMeasureCurrency", true
	case 1830:
		return "SettlPriceIncrement", true
	case 1831:
		return "SettlPriceSecondaryIncrement", true
	case 8100:
		return "FinalSettlCurrency", true
	default:
		return "", false
	}
}

func (f FIX50SP2CME) ValueName(tag int, value string) (string, bool) {
	switch tag {
	case 4:
		switch value {
		case "B":
...
(iii) market maker is reporting the onward leg of a riskless principal transaction where the legs are executed at different prices, and another market maker has submitted a trade report using trade type indicator M for the first leg (this requires a single trade report with trade type indicator R).)`, true
	...
	case 865:
		...
		case "21":
			return `Deliver start time`, true
		case "22":
			return `Delivery end time`, true
		case "23":
			return `First notice date`, true
		case "24":
			return `Last notice date`, true
		case "99":
			return `Other`, true
		}
	...
	case 871:
		...
		case "8":
			return `Coupon period (if not semi-annual)`, true
		case "9":
			return `When [and if] issued`, true
		case "10":
		...
		case "13":
			return `Escrowed to redemption date - callable`, true
		case "14":
		...
		case "20":
			return `Original issue discount price`, true
		case "21":
		...
		case "34":
			return `Test instrument`, true
		case "35":
			return `Dummy instrument`, true
		case "36":
			return `Negative settlement price eligibility`, true
		case "37":
			return `Negative strike price eligibility`, true
		case "99":
	...
	case 996:
		...
		case "GJ":
			return `gigajoules`, true
		case "t":
			return `Metric Tons (aka Tonne)`, true
		case "kWh":
			return `Kilowatt hours`, true
		case "MWh":
		...
		case "Ccy":
			return `Amount of currency`, true
		case "BDFT":
			return `Board feet`, true
		case "IPNT":
			return `Index point`, true
		case "day":
			return `Days`, true
		case "cwt":
			return `Hundredweight(US)`, true
		case "g":
			return `Grams`, true
		case "dt":
			return `Dry metric tons`, true
		case "EnvOfst":
			return `Environmental Offset`, true
		case "EnvCrd":
			return `Environmental Credit`, true
		case "kW-min ":
			return `Kilowatt-Minute (electrical capacity)`, true
		case "MW-min":
			return `Megawatt-Minute (electrical capacity)`, true
		case "kW-h":
			return `Kilowatt-Hour (electrical capacity)`, true
		case "MW-h":
			return `Megawatt-Hour (electrical capacity)`, true
		case "kW-d":
			return `Kilowatt-Day (electrical capacity)`, true
		case "MW-d":
			return `Megawatt-Day (electrical capacity)`, true
		case "kW-M":
			return `Kilowatt-Month (electrical capacity)`, true
		case "MW-M":
			return `Megawatt-Month (electrical capacity)`, true
		case "kW-a":
			return `Kilowatt-Year (electrical capacity)`, true
		case "MW-a":
			return `Megawatt-Year (electrical capacity)`, true
		}
	...
	case 1209:
		switch value {
		case "0":
			return `Regular trading`, true
		case "1":
			return `Variable cabinet`, true
		case "2":
			return `Fixed cabinet`, true
		case "3":
			return `Traded as a spread leg`, true
		case "4":
			return `Settled as a spread leg`, true
		case "5":
			return `Traded as spread`, true
		}
